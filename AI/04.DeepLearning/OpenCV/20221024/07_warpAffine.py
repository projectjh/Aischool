...
src = cv2.imread("../images/hasa.png", cv2.IMREAD_COLOR)
height, width, channel = src.shape
matrix = cv2.getRotationMatrix2D((width/2, height/2), 120, 1.5)
print(matrix)
dst = cv2.warpAffine(src, matrix, (width, height))  # 2행 3열 구조의 matrix값 전달이 필요
