...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // 미니 리스트에 설명을 추가하고 싶었다,
    // $('.explain i').mouseover(function(){
    //   $(this).siblings('.explainTxt').css('opacity', '1');
    // });
    // $('.explain i').mouseleave(function(){
    //   $(this).siblings('.explainTxt').css('opacity', '0');
    // });
  }, []);
